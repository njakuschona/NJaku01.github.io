...
Fehler_CO2_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_CO2_Zeit_test.csv", sep=" ")
Fehler_CO2_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_CO2_Verkehr_test.csv", sep=" ")
Fehler_NH3_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_NH3_Zeit_test.csv", sep=" ")
Fehler_NH3_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_NH3_Verkehr_test.csv", sep=" ")
Fehler_NO_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_NO_Zeit_test.csv", sep=" ")
Fehler_NO_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_NO_Verkehr_test.csv", sep=" ")
Fehler_NOx_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_NOx_Verkehr_test.csv", sep=" ")
Fehler_O3_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_O3_Zeit_test.csv", sep=" ")
Fehler_O3_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_O3_Verkehr_test.csv", sep=" ")
Fehler_PM1_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM1_Zeit_test.csv", sep=" ")
Fehler_PM1_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM1_Verkehr_test.csv", sep=" ")
Fehler_PM2.5_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM2.5_Zeit_test.csv", sep=" ")
Fehler_PM2.5_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM2.5_Verkehr_test.csv", sep=" ")
Fehler_PM10_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM10_Zeit_test.csv", sep=" ")
Fehler_PM10_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PM10_Verkehr_test.csv", sep=" ")
Fehler_PN10_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PN10_Zeit_test.csv", sep=" ")
Fehler_PN10_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/Fehler_PN10_Verkehr_test.csv", sep=" ")
#bis 20er-Werte
Fehler_NO2_Verkehr_test=read.csv("Paper/Daten/Verkehr_Zeit/bis_20/Fehler_NO2_Verkehr_test.csv", sep=" ")
Fehler_NO2_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/bis_20/Fehler_NO2_Zeit_test.csv", sep=" ")
Fehler_NOx_Zeit_test=read.csv("Paper/Daten/Verkehr_Zeit/bis_20/Fehler_NOx_Zeit_test.csv", sep=" ")
#-------------------------------------------------

Fehler_CO2_Schall_test=read.csv("Paper/Daten/Schall/Fehler_CO2_test.csv", sep=" ")
Fehler_NO2_Schall_test=read.csv("Paper/Daten/Schall/Fehler_NO2_mitlNOx_test.csv", sep=" ")
Fehler_NO_Schall_test=read.csv("Paper/Daten/Schall/Fehler_NO_mitlNOx_test.csv", sep=" ")
Fehler_O3_Schall_test=read.csv("Paper/Daten/Schall/Fehler_O3_test.csv", sep=" ")
Fehler_PM1_Schall_test=read.csv("Paper/Daten/Schall/Fehler_PM1_test.csv", sep=" ")
Fehler_PM2.5_Schall_test=read.csv("Paper/Daten/Schall/Fehler_PM2.5_test.csv", sep=" ")
Fehler_PM10_Schall_test=read.csv("Paper/Daten/Schall/Fehler_PM10_test.csv", sep=" ")
Fehler_PN10_Schall_test=read.csv("Paper/Daten/Schall/Fehler_PN10_test.csv", sep=" ")
#bis 20er Werte 

Fehler_NH3_Schall_test=read.csv("Paper/Daten/Schall/bis_20/Fehler_NH3_test.csv", sep=" ")
Fehler_NOx_Schall_test=read.csv("Paper/Daten/Schall/bis_20/Fehler_NOx_test.csv", sep=" ")
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
###########
#        ##
